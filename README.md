## gazebo_ros_pkgs (noetic) - 2.9.3-1

The packages in the `gazebo_ros_pkgs` repository were released into the `noetic` distro by running `/usr/bin/bloom-release gazebo_ros_pkgs --track noetic --ros-distro noetic` on `Wed, 26 Feb 2025 18:43:59 -0000`
...
## gazebo_ros_pkgs (noetic) - 2.9.2-1

The packages in the `gazebo_ros_pkgs` repository were released into the `noetic` distro by running `/usr/bin/bloom-release gazebo_ros_pkgs --track noetic --ros-distro noetic` on `Wed, 21 Apr 2021 18:24:07 -0000`
...
## gazebo_ros_pkgs (kinetic) - 2.5.21-1

The packages in the `gazebo_ros_pkgs` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release -r kinetic gazebo_ros_pkgs` on `Mon, 05 Apr 2021 17:31:00 -0000`
...
- upstream repository: https://github.com/ros-simulation/gazebo_ros_pkgs.git
- release repository: https://github.com/ros-gbp/gazebo_ros_pkgs-release.git
- rosdistro version: `2.5.20-1`
- old version: `2.5.20-1`
...
## gazebo_ros_pkgs (kinetic) - 2.5.20-1

The packages in the `gazebo_ros_pkgs` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --track kinetic --ros-distro kinetic gazebo_ros_pkgs` on `Fri, 08 May 2020 17:55:54 -0000`
...
- upstream repository: https://github.com/ros-simulation/gazebo_ros_pkgs.git
- release repository: https://github.com/ros-gbp/gazebo_ros_pkgs-release.git
- rosdistro version: `2.5.19-1`
- old version: `2.5.19-1`
- new version: `2.5.20-1`
...
## gazebo_ros_pkgs (melodic) - 2.8.7-1

The packages in the `gazebo_ros_pkgs` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --track melodic --ros-distro melodic gazebo_ros_pkgs` on `Fri, 01 May 2020 19:22:18 -0000`
...
## gazebo_ros_pkgs (melodic) - 2.8.5-1

The packages in the `gazebo_ros_pkgs` repository were released into the `melodic` distro by running `/usr/bin/bloom-release gazebo_ros_pkgs --ros-distro melodic` on `Tue, 04 Jun 2019 18:19:17 -0000`
...
## gazebo_ros_pkgs (kinetic) - 2.5.19-1

The packages in the `gazebo_ros_pkgs` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release gazebo_ros_pkgs --rosdistro kinetic` on `Tue, 04 Jun 2019 18:11:08 -0000`
...
- upstream repository: https://github.com/ros-simulation/gazebo_ros_pkgs.git
- release repository: https://github.com/ros-gbp/gazebo_ros_pkgs-release.git
- rosdistro version: `2.5.18-1`
- old version: `2.5.18-1`
- new version: `2.5.19-1`
...
## gazebo_ros_pkgs (kinetic) - 2.5.18-1

The packages in the `gazebo_ros_pkgs` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release gazebo_ros_pkgs --ros-distro kinetic --track kinetic` on `Thu, 24 Jan 2019 20:11:28 -0000`
...
- upstream repository: https://github.com/ros-simulation/gazebo_ros_pkgs.git
- release repository: https://github.com/ros-gbp/gazebo_ros_pkgs-release.git
- rosdistro version: `2.5.18-0`
- old version: `2.5.18-0`
- new version: `2.5.18-1`
...
## gazebo_ros_pkgs (kinetic) - 2.5.17-0

The packages in the `gazebo_ros_pkgs` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --ros-distro=kinetic --track=kinetic gazebo_ros_pkgs` on `Thu, 07 Jun 2018 10:37:47 -0000`
...
- upstream repository: https://github.com/ros-simulation/gazebo_ros_pkgs.git
- release repository: https://github.com/ros-gbp/gazebo_ros_pkgs-release.git
- rosdistro version: `2.5.14-1`
- old version: `2.5.16-0`
- new version: `2.5.17-0`
...
## gazebo_ros_pkgs (lunar) - 2.7.6-0

The packages in the `gazebo_ros_pkgs` repository were released into the `lunar` distro by running `/usr/bin/bloom-release --ros-distro=lunar --track=lunar gazebo_ros_pkgs` on `Thu, 07 Jun 2018 10:21:09 -0000`
...
## gazebo_ros_pkgs (melodic) - 2.8.3-0

The packages in the `gazebo_ros_pkgs` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --ros-distro=melodic --track=melodic gazebo_ros_pkgs` on `Mon, 04 Jun 2018 11:27:41 -0000`
...
## gazebo_ros_pkgs (lunar) - 2.7.5-0

The packages in the `gazebo_ros_pkgs` repository were released into the `lunar` distro by running `/usr/bin/bloom-release --ros-distro=lunar --track=lunar gazebo_ros_pkgs` on `Mon, 04 Jun 2018 11:09:59 -0000`
...
## gazebo_ros_pkgs (kinetic) - 2.5.16-0

The packages in the `gazebo_ros_pkgs` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --ros-distro=kinetic --track=kinetic gazebo_ros_pkgs` on `Mon, 04 Jun 2018 11:01:11 -0000`
...
- release repository: https://github.com/ros-gbp/gazebo_ros_pkgs-release.git
- rosdistro version: `2.5.14-1`
- old version: `2.5.14-1`
- new version: `2.5.16-0`
...
## gazebo_ros_pkgs (indigo) - 2.4.16-1

The packages in the `gazebo_ros_pkgs` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --ros-distro=indigo --track=indigo gazebo_ros_pkgs` on `Mon, 04 Jun 2018 10:53:59 -0000`
...
- upstream repository: https://github.com/ros-simulation/gazebo_ros_pkgs.git
- release repository: https://github.com/ros-gbp/gazebo_ros_pkgs-release.git
- rosdistro version: `2.4.15-0`
- old version: `2.4.16-0`
...
## gazebo_ros_pkgs (indigo) - 2.4.16-0

The packages in the `gazebo_ros_pkgs` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --ros-distro=indigo --track=indigo gazebo_ros_pkgs` on `Mon, 04 Jun 2018 10:45:54 -0000`
...
## gazebo_ros_pkgs (melodic) - 2.8.2-0

The packages in the `gazebo_ros_pkgs` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --rosdistro melodic --track melodic gazebo_ros_pkgs` on `Wed, 09 May 2018 22:28:14 -0000`
...
## gazebo_ros_pkgs (melodic) - 2.8.1-0

The packages in the `gazebo_ros_pkgs` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --rosdistro melodic --track melodic gazebo_ros_pkgs` on `Sat, 05 May 2018 16:08:26 -0000`
...
## gazebo_ros_pkgs (kinetic) - 2.5.14-1

The packages in the `gazebo_ros_pkgs` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release -t kinetic -r kinetic gazebo_ros_pkgs` on `Thu, 21 Dec 2017 23:39:32 -0000`
...
- upstream repository: https://github.com/ros-simulation/gazebo_ros_pkgs.git
- release repository: https://github.com/ros-gbp/gazebo_ros_pkgs-release.git
- rosdistro version: `2.5.14-0`
- old version: `2.5.14-0`
- new version: `2.5.14-1`
...
## gazebo_ros_pkgs (lunar) - 2.7.3-0

The packages in the `gazebo_ros_pkgs` repository were released into the `lunar` distro by running `/usr/bin/bloom-release --rosdistro lunar --track lunar gazebo_ros_pkgs` on `Mon, 11 Dec 2017 15:46:32 -0000`
...
## gazebo_ros_pkgs (kinetic) - 2.5.14-0

The packages in the `gazebo_ros_pkgs` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic gazebo_ros_pkgs` on `Mon, 11 Dec 2017 12:48:01 -0000`
...
- upstream repository: https://github.com/ros-simulation/gazebo_ros_pkgs.git
- release repository: https://github.com/ros-gbp/gazebo_ros_pkgs-release.git
- rosdistro version: `2.5.13-0`
- old version: `2.5.13-1`
...
## gazebo_ros_pkgs (kinetic) - 2.5.13-1

The packages in the `gazebo_ros_pkgs` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic gazebo_ros_pkgs` on `Mon, 11 Dec 2017 12:29:24 -0000`
...
- release repository: https://github.com/ros-gbp/gazebo_ros_pkgs-release.git
- rosdistro version: `2.5.13-0`
- old version: `2.5.13-0`
- new version: `2.5.13-1`
...
## gazebo_ros_pkgs (indigo) - 2.4.15-0

The packages in the `gazebo_ros_pkgs` repository were released into the `indigo` distro by running `/usr/bin/bloom-release gazebo_ros_pkgs --ros-distro=indigo --track=indigo` on `Wed, 09 Aug 2017 16:28:15 -0000`
...
- upstream repository: https://github.com/ros-simulation/gazebo_ros_pkgs.git
- release repository: https://github.com/ros-gbp/gazebo_ros_pkgs-release.git
- rosdistro version: `2.4.13-0`
- old version: `2.4.14-0`
- new version: `2.4.15-0`
...
## gazebo_ros_pkgs (indigo) - 2.4.14-0

The packages in the `gazebo_ros_pkgs` repository were released into the `indigo` distro by running `/usr/bin/bloom-release gazebo_ros_pkgs --ros-distro=indigo --track=indigo` on `Sat, 24 Jun 2017 16:47:24 -0000`
...
## gazebo_ros_pkgs (kinetic) - 2.5.13-0

The packages in the `gazebo_ros_pkgs` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release gazebo_ros_pkgs --ros-distro=kinetic --track=kinetic` on `Sat, 24 Jun 2017 16:38:51 -0000`
...
- upstream repository: https://github.com/ros-simulation/gazebo_ros_pkgs.git
- release repository: https://github.com/ros-gbp/gazebo_ros_pkgs-release.git
- rosdistro version: `2.5.12-0`
- old version: `2.5.12-0`
- new version: `2.5.13-0`
...
## gazebo_ros_pkgs (lunar) - 2.7.2-0

The packages in the `gazebo_ros_pkgs` repository were released into the `lunar` distro by running `/usr/bin/bloom-release --track lunar --ros-distro lunar gazebo_ros_pkgs` on `Sun, 21 May 2017 14:04:00 -0000`
...
## gazebo_ros_pkgs (lunar) - 2.7.1-0

The packages in the `gazebo_ros_pkgs` repository were released into the `lunar` distro by running `/usr/bin/bloom-release --ros-distro=lunar --track=lunar gazebo_ros_pkgs` on `Fri, 28 Apr 2017 00:29:28 -0000`
...
## gazebo_ros_pkgs (kinetic) - 2.5.12-0

The packages in the `gazebo_ros_pkgs` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --ros-distro=kinetic --track=kinetic gazebo_ros_pkgs` on `Mon, 24 Apr 2017 23:29:05 -0000`
...
- upstream repository: https://github.com/ros-simulation/gazebo_ros_pkgs.git
- release repository: https://github.com/ros-gbp/gazebo_ros_pkgs-release.git
- rosdistro version: `2.5.11-0`
- old version: `2.5.11-0`
- new version: `2.5.12-0`
...
## gazebo_ros_pkgs (kinetic) - 2.5.11-0

The packages in the `gazebo_ros_pkgs` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --ros-distro=kinetic --track=kinetic gazebo_ros_pkgs` on `Tue, 18 Apr 2017 18:00:54 -0000`
...
- upstream repository: https://github.com/ros-simulation/gazebo_ros_pkgs.git
- release repository: https://github.com/ros-gbp/gazebo_ros_pkgs-release.git
- rosdistro version: `2.5.10-0`
- old version: `2.5.10-0`
- new version: `2.5.11-0`
...
## gazebo_ros_pkgs (kinetic) - 2.5.10-0

The packages in the `gazebo_ros_pkgs` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --track kinetic --ros-distro kinetic gazebo_ros_pkgs` on `Fri, 03 Mar 2017 19:07:44 -0000`
...
- upstream repository: https://github.com/ros-simulation/gazebo_ros_pkgs.git
- release repository: https://github.com/ros-gbp/gazebo_ros_pkgs-release.git
- rosdistro version: `2.5.9-0`
- old version: `2.5.9-0`
- new version: `2.5.10-0`
...
## gazebo_ros_pkgs (indigo) - 2.4.13-0
